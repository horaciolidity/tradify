  ...
  return (
    <div className="space-y-6">
      ...
      <motion.div 
        ...
        className="relative h-48 md:h-64 rounded-3xl overflow-hidden group cursor-pointer"
      >
        <img src="/promo_banner.png" alt="Promo" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110" />
        <div className="absolute inset-0 bg-gradient-to-r from-dark/80 to-transparent flex flex-col justify-center px-10">
          <span className="text-primary font-bold uppercase tracking-widest text-xs mb-2">Platform Milestone</span>
          <h2 className="text-3xl md:text-4xl font-black text-white max-w-md leading-tight">
            $500k Liquidity Pool <br/> Now Live.
          </h2>
          <button className="mt-6 w-fit px-6 py-2.5 bg-white text-dark font-bold rounded-xl hover:bg-white/90 transition-all">
            Join Now
          </button>
        </div>
      </motion.div>
